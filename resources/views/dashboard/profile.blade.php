...
@section('breadcrumb')
   ...
   <li class="breadcrumb-item active" aria-current="page">
      <a href="{{ route('dashboard.posts.index') }}" class="text-decoration-none">Detail Post</a>
   </li>
@endsection
@section('container')
            ...
            <div class="row">
               ...
               <div class="col-md-9 border-right">
                  <div class="p-3 py-5">
                     ...
                     <div class="mt-5 d-flex justify-content-end"><button class="btn btn-primary profile-button px-5"
                           type="button">Save
                           Profile</button></div>
                  </div>
               </div>
