...
@section('breadcrumb')
   ...
   <li class="breadcrumb-item">
      <a href="{{ route('pelanggaran.index') }}" class="text-decoration-none">{{ __('Data Pelanggaran') }}</a>
   </li>
...
@section('container')
   ...
   <div class="card mb-5">
      <div class="card-body">
         ...
         @include('dashboard.pelanggaran.modal.create-klasifikasi
               ...
               <tbody>
                  @foreach ($klasifikasi as $k)
                     ...
                     if ($k->jenis == 'ringan') {
                        ...
                        $jenis = 'ringan';
                     } elseif ($k->jenis == 'sedang') {
                        $colorPoint = 'text-warning';
                        $jenis = 'sedang';
                     } elseif ($k->jenis == 'berat') {
                      ...
                      @endphp">
                           {{ $k->jenis }}</td>
                        <td>
                           <span class="{{ $colorPoint }}">{{ $k->poin }}</span>
                        </td>
                        ...
                        <td class="d-flex justify-content-center">
                           ...
                           <form action="{{ route('klasifikasi-pelanggaran.destroy', $k->id) }}" method="POST">
                              @method('delete')
                              @csrf
                        ...
                        @include('dashboard.pelanggaran.modal.edit-klasifikasi')
                        @include('dashboard.pelanggaran.modal.show-klasifikasi')
