...
@section('breadcrumb')
   ...
   <li class="breadcrumb-item" aria-current="page">
      <a href="{{ route('pelanggaran.edit', $pelanggaran->id) }}"
         class="text-decoration-none {{ Request::is('pelanggaran/amf' . $pelanggaran->id . '/edit') ? 'text-secondary' : '' }}">{{ $title }}</a>
   </li>
@endsection
@section('container')
               ...
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama"
                        value="{{ old('nama', $pelanggaran->nama) }}">
                     @error('nama')
               ...
               <div class="row">
                  <div class="col-lg-10">
                     ...
                     <input type="text" placeholder="Deskripsi Data ..."
                        ...
                        is-invalid
                     @enderror"
                        id="keterangan" name="keterangan" value="{{ old('keterangan', $pelanggaran->keterangan) }}">
                     @error('keterangan')
                        <div class="invalid-feedback">
                           {{ $message }}
                        </div>
