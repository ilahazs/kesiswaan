...
<li class="breadcrumb-item" aria-current="page">
   <a href="{{ route('pelanggaran.edit', $pelanggaran->id) }}" class="text-decoration-none {{ Request::is('pelanggaran/amf' . $pelanggaran->id . '/edit') ? 'text-secondary' : '' }}">{{ $title }}</a>
</li>
@endsection
@section('container')
               ...
               <div class="mb-3">
                  ...
                  <div class="row">
                     <div class="col-md-8">
                        ...
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama', $pelanggaran->nama) }}">
                        @error('nama')
                     ...
                     <div class="col-md-4">
                        <select class="form-control" name="jenis" id="jenis">
                           ...
                           } elseif ($pelanggaran->poin == 30) {
                           $jenisSebelumnya = 'sedang';
                           } elseif ($pelanggaran->poin == 50) {
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        ...
                        <textarea class="form-control @error('keterangan')
                            ...
                            @enderror" id="keterangan" name="keterangan" value="{{ old('keterangan') }}" rows="3">{{ $pelanggaran->keterangan }}</textarea>
                        @error('keterangan')
                        <div class="invalid-feedback">
                           {{ $message }}
                        </div>
