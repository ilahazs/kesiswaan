...
<div class="modal fade text-left" id="DetailPenghargaan{{ $penghargaan->id }}" data-backdrop="static"
   data-keyboard="false" tabindex="-1" aria-labelledby="DetailPenghargaan{{ $penghargaan->id }}Label"
   aria-hidden="true">
                        ...
                        <div class="mb-3 row">
                           ...
                           <div class="col-md-6">
                              <input type="text" disabled readonly class="form-control bg-white {{ $colorPoint }}"
                                 id="staticEmail" value="{{ $penghargaan->klasifikasi->poin }}">
                           </div>
                        </div>
                        <div class="mb-3 row">
                           <div class="col-md-5">
