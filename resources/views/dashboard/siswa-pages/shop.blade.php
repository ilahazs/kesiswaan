         ...
         @foreach ([1, 2] as $a)
            <div class="col-lg-6">
               <div class="card mb-3" style="max-width: 600px;">
                  <div class="row g-0">
                     <div class="col-md-4">
                        <img src="{{ asset('img/buku-mtk.jpg') }}" class="img-fluid rounded-start p-3 border-dark"
                           alt="..." width="200">
                     </div>
                     <div class="col-md-8">
                        <div class="card-body">
                           ...
                           <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur,
                              voluptate laudantium. Iste deleniti vero rerum veniam ipsam natus beatae animi incidunt,
                              laborum
