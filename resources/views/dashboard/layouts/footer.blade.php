...
<footer class="footer text-center text-lg-start text-white" style="margin-top: 80px">
   <!-- Grid container -->
   ...
   <!-- Copyright -->
   <div class="text-center text-sm-center p-3" style="background-color: rgba(8, 8, 9, 0.638)">
