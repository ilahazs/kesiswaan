...
<body class="text-center">
   ...
   <main class="form-signin">
      <div class="row">
         <div class="col-lg-2">
            <a href="{{ route('index') }}">
               <img class="mb-4" src="{{ asset('img/logo-smkn4bdg.png') }}" alt="Logo SMKN 4 Bandung"
         ...
         <div class="col-lg-4 align-self-center" style="margin-bottom: 150px">
            <h1 class="h1 mb-2 fw-normal text-white text-start">{{ $title }}</h1>
